//------------------------------------------------------------------------------
// <copyright file="AskCommandPackage.cs" company="Company">
...
namespace RallyExtension.MenuCommands.AskCommand
{
    ...
    {
        /// <summary>
        /// AskCommandPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "1b2b9105-a62c-4206-9135-b089f026fee5";

        /// <summary>
        /// Initializes a new instance of the <see cref="AskCommand"/> class.
        /// </summary>
        public AskCommandPackage()
        {
